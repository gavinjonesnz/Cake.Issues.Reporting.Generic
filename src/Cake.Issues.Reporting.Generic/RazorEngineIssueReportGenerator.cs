...
namespace Cake.Issues.Reporting.Generic
{
    ...
    /// </summary>
    internal class RazorEngineIssueReportGenerator : IssueReportFormat, IGenericIssueReportGenerator
    {
        private readonly GenericIssueReportFormatSettings genericIssueReportFormatSettings;

        /// <summary>
        /// Initializes a new instance of the <see cref="RazorEngineIssueReportGenerator"/> class.
        /// </summary>
        /// <param name="log">The Cake log context.</param>
        /// <param name="settings">Settings for reading the log file.</param>
        public RazorEngineIssueReportGenerator(ICakeLog log, GenericIssueReportFormatSettings settings)
            : base(log)
        {
